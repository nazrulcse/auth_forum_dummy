...
unless AuthForum::Category.all.present?
...
unless AuthForum::Post.all.present?
...
unless AuthForum::AdminUser.all.present?
  AuthForum::AdminUser.create!(:email => 'admin@example.com', :password => 'password', :password_confirmation => 'password')
end